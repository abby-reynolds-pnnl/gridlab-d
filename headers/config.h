...
#define PACKAGE_STRING "GridLAB-D 5.3.0 Redhawk (Branch:python_bindings - 238cf59a)"
...
/* Define to 1 if the MySQL library is present. */
/* #undef HAVE_MYSQL */
...
#define HAVE_THREAD_POLICY_SET 1
